...
const BASE_URL_PROXY = "http://localhost:3000/user";
...
export const updateProfile = async (values) => {
  return await request.post(`${BASE_URL_SPRING}/updateProfile`, { values });
};

export const getUserCart = async () => {
  return await request.get(`${BASE_URL_PROXY}/cart`);
};
